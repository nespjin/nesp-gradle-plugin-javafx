...
public final class BuildClassGenerate {
    private static final String TAG = "BuildClassGenerate";

    private static final String R_CLASS_NAME = "Build";

    private final File mSourceDir;
    private final String mPackageName;
    private final DefaultConfig mDefaultConfig;

    public BuildClassGenerate(File sourceDir, String packageName, DefaultConfig defaultConfig) {
